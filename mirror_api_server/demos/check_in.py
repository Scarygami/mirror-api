...
__all__ = ["handle_location", "WELCOMES", "ROUTES"]
...
def handle_location(item, service, test):
    ...
    Card layout for cover:
        <article class="photo">
            ...
            <div class="photo-overlay"></div>
            <footer><div>4 places nearby</div></footer>
        </article>

    Card layout for detailed card, with navigate and custom check-in option:
        <article>
            <figure>
                <img src="https://lh3.googleusercontent.com/-khaIYLifQik/AAAAAAAAAAI/AAAAAAAA3bA/CWAtORun9is/photo.jpg?sz=240" width="240">
                <div><p class="text-small align-center">Place name </p></div>
            </figure>
            <section>
